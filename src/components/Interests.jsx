    ...
    <div className="flex flex-col items-center w-full px-4">
      ...
      <div className="flex flex-row items-center w-full mt-8 px-20">
        ...
        <div className="h-[50vh] rounded-lg bg-white shadow-lg flex flex-col justify-end p-6 w-1/2">
          ...
          <p className="p-8 text-gray-700 text-5xl">To rework electric hydrofoiling bikes for <a href="https://manta5.com/" target="_blank" rel="noopener noreferrer" className="text-black hover:text-blue-700 transition duration-300 transform hover:scale-105">Manta5</a>. That was cool!</p>
        </div>
      </div>
      <div className="flex flex-row items-center w-full mt-8 px-20">
        <div className="h-[50vh] rounded-lg overflow-hidden w-1/2 px-8">
