...
const Navbar = () => (
  <nav className="z-50 bg-white/50 backdrop-blur flex justify-center items-center px-8 py-3 max-w-5xl mx-auto rounded-full">
    ...
    <ul className="flex gap-6 text-gray-700 font-medium">
      ...
      <li><a href="#experience" className="text-xl font-bold hover:text-blue-500 transition border border-gray-300 rounded-full px-7 py-2 bg-white/70">Experience</a></li>
